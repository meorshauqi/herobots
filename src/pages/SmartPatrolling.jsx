          ...
          >
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute -left-2 md:left-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-black/70 md:bg-black/50 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-orange-500/20 hover:border-orange-500/50 transition-all duration-300 hover:scale-110"
              ...
              <button
                ...
                className="absolute -right-2 md:right-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-black/70 md:bg-black/50 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-orange-500/20 hover:border-orange-500/50 transition-all duration-300 hover:scale-110"
                              ...
                              <ul className="space-y-2 max-w-xl mx-auto">
                                {feature.details.map((detail, idx) => (
                                  <li key={idx} className={`flex items-start ${isActive ? 'text-sm' : 'text-xs'} text-gray-400 transition-all duration-300`}>
                                    <svg className={`${isActive ? 'w-4 h-4' : 'w-3 h-3'} text-orange-500 mr-2 mt-0.5 flex-shrink-0`} fill="currentColor" viewBox="0 0 20 20">
                                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                                    </svg>
                                    <span>{detail}</span>
                                  </li>
