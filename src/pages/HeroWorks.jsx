...
const generateParticles = () => [...Array(25)].map((_, i) => ({
  ...
  delay: `${(i * 0.2) % 5}s`,
  duration: `${12 + (i % 6)}s`,
  color: i % 3 === 0 ? 'bg-purple-400/40' : i % 3 === 1 ? 'bg-pink-400/40' : 'bg-indigo-400/40'
}));
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="relative pt-10 pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {particles.map((particle) => (
            <div
              key={particle.id}
              className={`absolute w-1 h-1 rounded-full heroworks-particle ${particle.color}`}
              style={{
                left: particle.left,
                top: particle.top,
        ...
        <div className="absolute top-1/2 left-1/2 w-[700px] h-[700px] rounded-full blur-3xl heroworks-spin-slow -z-10" style={{
          background: 'conic-gradient(from 0deg, rgba(147, 51, 234, 0.1), rgba(219, 39, 119, 0.1), rgba(99, 102, 241, 0.1), rgba(147, 51, 234, 0.1))'
        }}></div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-left relative">
                {/* Decorative Line */}
                <div className="hidden lg:block absolute -left-6 top-0 w-1 h-32 bg-gradient-to-b from-purple-500 via-pink-500 to-indigo-500 rounded-full heroworks-glow-badge"></div>

                {/* Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-500/10 border border-purple-500/30 rounded-full mb-6 heroworks-glow-badge animate-fadeInDown" style={{ animationDelay: '0.05s', animationFillMode: 'both' }}>
                  <div className="w-2 h-2 bg-purple-500 rounded-full animate-pulse"></div>
                  <span className="text-sm font-mono text-purple-400 uppercase tracking-wider">HR Management Platform</span>
                </div>
              ...
              <div className="relative animate-fadeInUp flex justify-center lg:justify-end" style={{ animationDelay: '0.5s', animationFillMode: 'both' }}>
                <div className="relative w-full" style={{ maxWidth: '280px' }}>
                  {/* Outer Glow */}
                  <div className="absolute -inset-6 bg-gradient-to-r from-purple-600/30 to-pink-600/30 rounded-3xl blur-2xl -z-10 animate-pulse-slow"></div>
                  
                  {/* HUD Container */}
                  <div className="relative rounded-2xl overflow-hidden border border-purple-500/30 shadow-2xl bg-black/40 backdrop-blur-sm">
                    {/* Corner Brackets */}
                    <div className="absolute top-0 left-0 w-6 h-6 border-l-2 border-t-2 border-purple-400 z-20"></div>
                    <div className="absolute top-0 right-0 w-6 h-6 border-r-2 border-t-2 border-purple-400 z-20"></div>
                    <div className="absolute bottom-0 left-0 w-6 h-6 border-l-2 border-b-2 border-pink-400 z-20"></div>
                    <div className="absolute bottom-0 right-0 w-6 h-6 border-r-2 border-b-2 border-pink-400 z-20"></div>
                    
                    {/* Scanning Line */}
                    <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
                      <div className="absolute w-full h-0.5 bg-gradient-to-r from-transparent via-purple-400/60 to-transparent heroworks-scan-line"></div>
                    </div>
                    ...
                    {/* Status Badge */}
                    <div className="absolute top-3 right-3 flex items-center gap-1.5 px-2 py-1 bg-purple-500/20 border border-purple-500/40 rounded-full z-20">
                      <div className="w-1.5 h-1.5 bg-purple-400 rounded-full animate-pulse"></div>
                      <span className="text-[9px] font-mono text-purple-300 uppercase">Active</span>
                    </div>
                    
                    {/* Bottom Info Panel */}
                    <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/90 to-transparent z-10">
                      <div className="flex items-center justify-between text-[9px] font-mono">
                        <span className="text-purple-400">HRMS v2.0</span>
                        <span className="text-pink-400">Cloud Ready</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute -bottom-2 -left-2 w-2 h-2 bg-pink-400/60 rounded-full animate-ping" style={{ animationDelay: '0.5s' }}></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 border-y border-white/10 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-0 w-72 h-72 bg-purple-600/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 right-0 w-72 h-72 bg-pink-600/10 rounded-full blur-3xl"></div>
          ...
          >
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute -left-2 md:left-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-black/70 md:bg-black/50 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-purple-500/20 hover:border-purple-500/50 transition-all duration-300 hover:scale-110"
              ...
              <button
                ...
                className="absolute -right-2 md:right-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-black/70 md:bg-black/50 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-purple-500/20 hover:border-purple-500/50 transition-all duration-300 hover:scale-110"
              ...
              <div className="overflow-hidden px-4 md:px-16">
                    ...
                    {modules.map((module, index) => {
                      ...
                      return (
                        <div key={index} className="w-full flex-shrink-0 px-2">
                          <div className={`group relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-white/20 transition-all duration-500 p-6 w-full rounded-xl ${isActive ? 'opacity-100' : 'opacity-50'}`}>
                            <div className={`absolute inset-0 bg-gradient-to-r ${module.gradient} opacity-10 rounded-xl`}></div>
                            <div className={`absolute top-0 left-0 h-full w-1 bg-gradient-to-b ${module.gradient} rounded-l-xl`}></div>
                            <div className="relative z-10">
                              <h3 className={`text-xl font-bold mb-3 bg-gradient-to-r ${module.gradient} bg-clip-text text-transparent text-center`}>{module.title}</h3>
                              <p className="text-gray-300 text-sm mb-4 leading-relaxed text-center">{module.description}</p>
                ...
                <div className="hidden md:block">
                  <div 
                    className="flex transition-transform duration-500 ease-in-out"
                    style={{ transform: `translateX(calc(33.333% - ${activeModuleIndex * 33.333}%))`, minHeight: '500px' }}
                  >
                    {modules.map((module, index) => {
                      const isActive = index === activeModuleIndex;
                      ...
                      return (
                        <div key={index} className="w-1/3 flex-shrink-0 px-4 flex items-center">
                          <div className={`group relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border transition-all duration-500 p-6 md:p-8 w-full rounded-xl ${
                            isActive ? 'border-purple-500/30 scale-100 shadow-2xl z-10 opacity-100' : isPrevious || isNext ? 'border-white/10 scale-95 opacity-70' : 'border-white/5 scale-90 opacity-50'
                          }`} style={{ minHeight: '450px' }}>
                            <div className={`absolute inset-0 bg-gradient-to-r ${module.gradient} rounded-xl ${isActive ? 'opacity-10' : isPrevious || isNext ? 'opacity-5' : 'opacity-3'} transition-opacity duration-500`}></div>
                            <div className={`absolute top-0 left-0 h-full w-1 bg-gradient-to-b ${module.gradient} rounded-l-xl ${isActive ? 'opacity-100' : 'opacity-50'}`}></div>
                            <div className="relative z-10">
                              <h3 className={`${isActive ? 'text-2xl' : isPrevious || isNext ? 'text-xl' : 'text-lg'} font-bold mb-3 bg-gradient-to-r ${module.gradient} bg-clip-text text-transparent text-center transition-all duration-300`}>{module.title}</h3>
                              <p className={`text-gray-300 ${isActive ? 'text-base' : 'text-sm'} mb-4 leading-relaxed text-center transition-all duration-300`}>{module.description}</p>
                              <ul className="space-y-2 max-w-xl mx-auto">
                                {module.details.map((detail, idx) => (
                                  <li key={idx} className={`flex items-start ${isActive ? 'text-sm' : 'text-xs'} text-gray-400 transition-all duration-300`}>
          ...
          >
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute -left-2 md:left-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-black/70 md:bg-black/50 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-pink-500/20 hover:border-pink-500/50 transition-all duration-300 hover:scale-110"
              ...
              <button
                ...
                className="absolute -right-2 md:right-0 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-black/70 md:bg-black/50 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-pink-500/20 hover:border-pink-500/50 transition-all duration-300 hover:scale-110"
                    ...
                    <button
                      ...
                      className={`transition-all duration-300 ${
                        idx === activeFeatureIndex
                          ? 'w-3 h-3 bg-pink-500 rounded-full'
                          : 'w-2 h-2 bg-white/30 rounded-full hover:bg-white/50'
                      }`}
              ...
              <div className="overflow-hidden px-4 md:px-16">
                      ...
                      return (
                        <div key={index} className="w-full flex-shrink-0 px-2">
                          <div className={`group relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-white/20 transition-all duration-500 p-6 w-full rounded-xl ${isActive ? 'opacity-100' : 'opacity-50'}`}>
                            ...
                            <div className="relative z-10">
                              <h3 className={`text-xl font-bold mb-3 bg-gradient-to-r ${feature.gradient} bg-clip-text text-transparent text-center`}>{feature.title}</h3>
                              <p className="text-gray-300 text-sm mb-4 leading-relaxed text-center">{feature.description}</p>
                              <ul className="space-y-2">
                ...
                <div className="hidden md:block">
                  <div 
                    className="flex transition-transform duration-500 ease-in-out"
                    style={{ transform: `translateX(calc(33.333% - ${activeFeatureIndex * 33.333}%))`, minHeight: '500px' }}
                  >
                    {keyFeatures.map((feature, index) => {
                      const isActive = index === activeFeatureIndex;
                      ...
                      return (
                        <div key={index} className="w-1/3 flex-shrink-0 px-4 flex items-center">
                          <div className={`group relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border transition-all duration-500 p-6 md:p-8 w-full rounded-xl ${
                            isActive ? 'border-pink-500/30 scale-100 shadow-2xl z-10 opacity-100' : isPrevious || isNext ? 'border-white/10 scale-95 opacity-70' : 'border-white/5 scale-90 opacity-50'
                          }`} style={{ minHeight: '450px' }}>
                            ...
                            <div className="relative z-10">
                              <h3 className={`${isActive ? 'text-2xl' : isPrevious || isNext ? 'text-xl' : 'text-lg'} font-bold mb-3 bg-gradient-to-r ${feature.gradient} bg-clip-text text-transparent text-center transition-all duration-300`}>{feature.title}</h3>
                              <p className={`text-gray-300 ${isActive ? 'text-base' : 'text-sm'} mb-4 leading-relaxed text-center transition-all duration-300`}>{feature.description}</p>
                              <ul className="space-y-2 max-w-xl mx-auto">
                                {feature.details.map((detail, idx) => (
                                  <li key={idx} className={`flex items-start ${isActive ? 'text-sm' : 'text-xs'} text-gray-400 transition-all duration-300`}>
                                    <svg className={`${isActive ? 'w-4 h-4' : 'w-3 h-3'} text-green-500 mr-2 mt-0.5 flex-shrink-0`} fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            {/* Outer Glow */}
            <div className="absolute -inset-4 bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-indigo-500/20 rounded-3xl blur-3xl animate-pulse-slow"></div>
            
            <div className="relative bg-gradient-to-br from-gray-900/90 to-black border border-purple-500/20 rounded-3xl p-12 md:p-16 overflow-hidden">
              {/* Corner Accents */}
              ...
              {/* Background Effects */}
              <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-full blur-3xl"></div>
              <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 rounded-full blur-3xl"></div>
              ...
              <div className="relative z-10">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-500/10 border border-purple-500/30 rounded-full mb-8 heroworks-glow-badge">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 via-pink-500 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  </Link>
                  <Link 
                    to="/contact"
                    className="group inline-flex items-center justify-center px-8 py-4 bg-white/5 border border-white/20 text-white font-semibold text-lg rounded-xl hover:bg-white/10 hover:border-purple-500/50 transition-all duration-300"
                  >
      ...
      <style jsx>{`
        ...
        @keyframes badgeGlow {
          ...
          50% { box-shadow: 0 0 25px rgba(147, 51, 234, 0.5), 0 0 40px rgba(219, 39, 119, 0.3); }
        }

        .heroworks-glow-badge {
          animation: badgeGlow 3s ease-in-out infinite;
        }

        /* Gradient Text Glow */
        .heroworks-gradient-text {
          text-shadow: 0 0 40px rgba(147, 51, 234, 0.4), 0 0 80px rgba(219, 39, 119, 0.2);
        }
