  ...
  return (
    <section className="relative bg-black overflow-hidden py-20 min-h-screen">
      ...
      <div className="relative mb-32 md:mb-40 w-full py-16">
        ...
        <h2 className="text-[30vw] md:text-[20vw] lg:text-[15vw] font-bold bg-gradient-to-r from-yellow-600/30 via-purple-600/30 to-yellow-600/30 bg-clip-text text-transparent leading-none select-none text-center w-full">
          OUR VISION
        </h2>
